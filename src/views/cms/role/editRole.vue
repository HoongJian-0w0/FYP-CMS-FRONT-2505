<!-- editRole.vue -->
<template>
  <el-dialog v-model="props.visible" title="Edit Role" width="600px" @close="handleClose">
    <el-form ref="editRef" :model="roleModel" :rules="rules" label-width="auto" @submit.prevent>
